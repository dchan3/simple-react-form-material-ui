...
var MaterialObject =
/*#__PURE__*/
function (_ObjectComponent) {
  _inherits(MaterialObject, _ObjectComponent);

  function MaterialObject() {
    _classCallCheck(this, MaterialObject);

    return _possibleConstructorReturn(this, _getPrototypeOf(MaterialObject).apply(this, arguments));
  }
  ...
  _createClass(MaterialObject, [{
    ...
    value: function render() {
      ...
      }, this.props.errorMessage), this.getChildrenComponents());
    }
  }]);
